...
exports.TextBoxGroup = undefined;
...
var TextBoxGroup = function TextBoxGroup(props) {
    ...
    return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement(_Label.Label, { text: props.label, style: { display: "block", color: color } }),
        _react2.default.createElement(_TextBox.TextBox, { name: props.name, type: props.type, value: props.value,
...
var TextBox = function TextBox(props) {
    return _react2.default.createElement("input", { type: props.type || "text", name: props.name, value: props.value,
